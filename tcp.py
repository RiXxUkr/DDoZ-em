    ...
    def __init__(self, ip, port, threads):
        ...
        while self.threadEvent.isSet():
            try:
                ...
                self.timeSec += 1/10
                print(f'\33[0m\33[92m+Request #{self.packetCount} \33[91m/ \33[93m{round(self.timeSec, 1)} Secs \33[91m/ \33[94m{self.sentSecPack} Packets/s \33[91m~ \33[95m{round(self.sentMb, 1)} MBits \33[91m/ \33[96m{round(self.sentSecMb, 1)} MBits/s \33[91m-> \33[97m{self.ip}@{self.port}')
            #Ctrl+C
